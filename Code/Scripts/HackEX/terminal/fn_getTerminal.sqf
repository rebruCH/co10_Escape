...
//_defaultValues = [] call compile preprocessFileLineNumbers ("Scripts\HackEX\config\terminals\" + str _target + ".sqf");
_defaultValues = [] call compile preprocessFileLineNumbers ("Scripts\HackEX\config\terminals\terminal.sqf");
